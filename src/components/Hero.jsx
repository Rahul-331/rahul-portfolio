      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        >
          {[
            ...
            <motion.div
              ...
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.9 + index * 0.1, duration: 0.4, ease: "easeOut" }}
              className="rounded-3xl border border-white/10 bg-slate-950/80 px-6 py-6 text-left shadow-xl shadow-cyan-500/5 transition-all hover:-translate-y-2 hover:border-cyan-400/50 hover:shadow-cyan-500/20"
            >
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="text-slate-200 transition-all hover:text-cyan-400"
          >
            <FaGithub />
          </motion.a>
          <motion.a
